...
export const RichTextEditor = ({ content, children, onEditorReady }: RichTextEditorProps) => {
  ...
  useEffect(() => {
    if (editor && onEditorReady && !hasNotifiedReady.current) {
